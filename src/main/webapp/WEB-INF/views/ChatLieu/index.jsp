...
<html>
  ...
  <body>
    <div class="container">
      <h1 style="line-height: 100px; text-align: center; color: red">Chất Liệu</h1>
      <div class="search-container">
        <form action="${pageContext.request.contextPath}/chatLieu/search">
          <input
            type="text"
    ...
    <section class="container">
          ...
          <c:if test="${f:length(list.getContent())!=0}">
            <c:forEach items="${list.getContent()}" var="dg" varStatus="status">
              <tr>
                ...
                <td style="text-align: left">${dg.tenChatLieu}</td>
                <td>${dg.ghiChu}</td>
                <td>${dg.ngayTao}</td>
                <td>${dg.ngaySua}</td>
                <td>${dg.trangThai ==  1 ? "✔" : "✖"}</td>
                <td>
                  <a href="chatLieu/edit/${dg.id}" class="btn btn-primary"
                    >Cập nhật</a
                  >
                </td>
              </tr>
      ...
      <p style="text-align: right; bottom: 0px">
        <a
          href="${pageContext.request.contextPath}/chatLieu/create"
