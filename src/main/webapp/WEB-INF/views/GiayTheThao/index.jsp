    ...
    <div class="" style="margin-top: 0px; margin-bottom: 20px">
        ...
        <div class="row">
            ...
            <div class="col-2" style="margin-left: 45px">
                <a href="/GiayTheThao/index" style="text-decoration: none">
                    <button class="button" style="width: 130px;margin-top: 0px; margin-bottom: 20px">
                        <svg class="svg-icon" fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg"><g stroke="#ff342b" stroke-linecap="round" stroke-width="1.5"><path d="m3.33337 10.8333c0 3.6819 2.98477 6.6667 6.66663 6.6667 3.682 0 6.6667-2.9848 6.6667-6.6667 0-3.68188-2.9847-6.66664-6.6667-6.66664-1.29938 0-2.51191.37174-3.5371 1.01468"></path><path d="m7.69867 1.58163-1.44987 3.28435c-.18587.42104.00478.91303.42582 1.0989l3.28438 1.44986"></path></g></svg>
                    ...
                    <table class="data-table" style="margin-top: 30px;width: 100%;border-radius: 50px 50px 50px">
                        ...
                        <tr>
                            ...
                            <th style="padding-top: 5px; text-align: center; color: black;width: 180px">Giá bán VNĐ
                                <a href="${pageContext.request.contextPath}/GiayTheThao/index?sort=desc">
                                    <i class="fa fa-caret-down" style="font-size: 1.5em;"></i>
                                </a>
                                <a href="${pageContext.request.contextPath}/GiayTheThao/index?sort=asc">
        ...
        <div class="sliderTab" >
            <ul class="nav-tabs">
                <li class="nav-item ${param.tab == 'active' ? 'active' : ''}" data-target="tab1" style="text-decoration: none;margin-bottom: 40px;" >
                    <a href="${pageContext.request.contextPath}/GiayTheThao/index?tab=active" class="nav-link" style="">
                        Đã kích hoạt
                    </a>
                </li>
                <li class="nav-item ${param.tab == 'inactive' ? 'active' : ''}" data-target="tab2" style="text-decoration: none">
                    <a href="${pageContext.request.contextPath}/GiayTheThao/index?tab=inactive" class="nav-link" style="">
                        Chưa kích hoạt
                    </a>
                </li>
                            ...
                            <ul class="pagination" style="margin-left: 400px">
                                <c:choose>
                                    <c:when test="${currentPage > 1}">
                                        <li class="page-item">
                                            <a href="/GiayTheThao/index?pageNum=${currentPage - 1}&tab=active" class="page-link" style="border: 1px solid red;width: 100px">Previous</a>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <c:forEach var="pageNumber" items="${pageNumbers}">
                                    <li class="page-item ${pageNumber == currentPage ? 'active' : ''}">
                                        <a href="/GiayTheThao/index?pageNum=${pageNumber}&tab=active" class="page-link">${pageNumber}</a>
                                    </li>
                                </c:forEach>

                                <c:if test="${currentPage < totalPage}">
                                    <li class="page-item">
                                        <a href="/GiayTheThao/index?pageNum=${currentPage + 1}&tab=active" class="page-link" style="border: 1px solid red; width: 50px">Next</a>
                                    </li>
                                </c:if>
                            </ul>
                        </div>
                        ...
                        <div class="col-12" style="">
                            <ul class="pagination" style="margin-left: 400px">
                                <c:choose>
                                    <c:when test="${currentPage > 1}">
                                        <li class="page-item">
                                            <a href="/GiayTheThao/index?pageNum=${currentPage - 1}&tab=inactive" class="page-link" style="border: 1px solid red;width: 100px">Previous</a>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                                        <!-- Ẩn nút "Previous" khi trang hiện tại là trang đầu tiên -->
                                ...
                                <c:forEach var="pageNumber" items="${pageNumbers}">
                                    <li class="page-item ${pageNumber == currentPage ? 'active' : ''}">
                                        <a href="/GiayTheThao/index?pageNum=${pageNumber}&tab=inactive" class="page-link">${pageNumber}</a>
                                    </li>
                                </c:forEach>

                                <c:if test="${currentPage < totalPage}">
                                    <li class="page-item">
                                        <a href="/GiayTheThao/index?pageNum=${currentPage + 1}&tab=inactive" class="page-link" style="border: 1px solid red; width: 50px">Next</a>
                                    </li>
                                </c:if>
                            </ul>
                        </div>
