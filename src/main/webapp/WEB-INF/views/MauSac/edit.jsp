...
<div class="container">
    ...
    <div>
        <h1 style="text-align: center; color: black; margin-top: 30px; margin-bottom: 60px">Edit dữ liệu bảng màu
            sắc</h1>
        <frm:form
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <frm:errors cssClass="text-danger" path="tenMauSac"></frm:errors>
